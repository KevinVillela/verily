...
step_1_label = tk.Label(root, text='Step 1 (ONLY DO THIS ONCE): Close all open windows and Install the Printer Software. If no errors pop up, it will have been installed under the name "Req Printer AutoAdded"', fg="black", wraplength=250, justify=LEFT)
